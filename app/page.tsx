      ...
      <main className="flex-1 container mx-auto px-6 py-12 flex flex-col items-center">
        <div className="text-center max-w-3xl mb-12">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-black dark:text-white mb-6">
            Empower Your Business with <span className="text-transparent bg-clip-text bg-linear-to-r from-red-600 to-red-400">Biz360Prime</span>
          </h1>
          <p className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400">
            A comprehensive suite of powerful software solutions designed to streamline your operations, from accounting and HR to CRM and intelligent BI insights.
          </p>
        </div>
