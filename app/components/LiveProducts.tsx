...
const liveProducts = [
  {
    name: "Marketing360",
    description: "Supercharge your growth. Launch targeted campaigns, manage multi-channel reach, and automate your entire marketing funnel from a powerful single interface.",
  ...
  {
    name: "HRM360",
    description: "Streamline your workforce. Manage payroll, employee onboarding, benefits tracking, and team performance evaluations with ease.",
...
export default function LiveProducts() {
  return (
    <section className="py-24 w-full bg-zinc-50 dark:bg-zinc-950 border-t border-zinc-200 dark:border-zinc-800" id="live-products">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
            Experience the power of Biz360Prime today. These flagship modules are fully deployed and ready to integrate into your workflow.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {liveProducts.map((product) => (
            ...
            >
              <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 shadow-lg ${product.color}`}>
                {product.icon}
              </div>
              ...
              <a 
                ...
                className={`inline-flex items-center gap-2 px-6 py-3 rounded-full text-white font-semibold transition-all shadow-md group-hover:scale-105 ${product.color} ${product.hoverColor}`}
              >
